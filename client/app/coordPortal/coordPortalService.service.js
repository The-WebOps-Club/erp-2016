...
angular.module('erp2015App')
  .service('CoordPortalService', function CoordPortalService ($http) {
      ...
      getFilesFromDepartment: function(department){
        return $http.get('http://coordportal.shaastra.org:9000/api/imgs/' + department).then(function (response){
          return response.data;
        });
      },

      downloadFile: function(department, file){
        return $http.get('http://coordportal.shaastra.org:9000/api/imgs/' + department + '/' + file).then(function (response){
          return response.data;
        });
      },
